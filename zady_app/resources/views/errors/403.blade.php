...
<body>
    <div class="wrap">
        ...
        <h1 class="title">ليس لديك صلاحية للوصول</h1>
        <p class="body">
            هذه الصفحة غير متاحة لك. إذا كنت تعتقد أن هذا خطأ، تواصل مع الإدارة.
        </p>
        @auth
            <a href="{{ url('/') }}" class="btn">العودة إلى لوحتي</a>
        @else
            <a href="{{ route('login') }}" class="btn">العودة إلى صفحة الدخول</a>
        @endauth
    </div>
</body>
</html>
