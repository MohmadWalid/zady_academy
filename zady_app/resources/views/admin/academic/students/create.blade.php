...
<div class="max-w-3xl mx-auto">
    ...
    <x-card>
        <form action="{{ route('admin.academic.students.store') }}" method="POST" class="flex flex-col gap-6">
            @csrf
            ...
            <div class="pt-4 flex gap-4">
                ...
                <a href="{{ route('admin.academic.students.index') }}" class="flex-1 bg-surface border border-border text-text-secondary h-12 rounded-xl font-bold flex items-center justify-center hover:bg-bg transition-all">إلغاء</a>
            </div>
        </form>
    </x-card>
</div>
