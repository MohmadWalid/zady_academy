...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/lido/zady_academy/zady_app/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/lido/zady_academy/zady_app/public/storage','logging.default','logging.deprecations.channel',
...
'proofs.show','admin.dashboard','admin.payments.pending','admin.payments.cash','admin.payments.history',
'admin.payments.transfers','admin.payments.approve','admin.payments.reject','admin.payments.refund','admin.academic.students.index',
'admin.academic.students.create','admin.academic.students.store','admin.academic.students.show','admin.academic.students.edit','admin.academic.students.update',
'admin.academic.students.destroy','admin.academic.students.restore','admin.academic.groups.index','admin.academic.groups.create','admin.academic.groups.store',
'admin.academic.groups.show','admin.academic.groups.edit','admin.academic.groups.update','admin.academic.groups.destroy','admin.academic.groups.restore',
'admin.academic.groups.sessions.store','admin.academic.groups.sessions.destroy','admin.academic.users.index','admin.academic.users.create','admin.academic.users.store',
'admin.academic.users.show','admin.academic.users.edit','admin.academic.users.update','admin.academic.users.destroy','admin.academic.users.restore',
'admin.academic.subscriptions.index','admin.academic.subscriptions.create','admin.academic.subscriptions.store','admin.academic.subscriptions.show','admin.academic.subscriptions.edit',
'admin.academic.subscriptions.update','admin.academic.subscriptions.destroy','admin.academic.subscriptions.restore','admin.attendance.index','admin.attendance.show',
'secretary.dashboard','secretary.payments.pending','secretary.payments.cash','secretary.payments.history','secretary.payments.approve',
'secretary.payments.reject','secretary.academic.students.index','secretary.academic.students.create','secretary.academic.students.store','secretary.academic.students.show',
'secretary.academic.students.edit','secretary.academic.students.update','secretary.academic.students.destroy','secretary.academic.groups.index','secretary.academic.groups.create',
'secretary.academic.groups.store','secretary.academic.groups.show','secretary.academic.groups.edit','secretary.academic.groups.update','secretary.academic.groups.destroy',
'secretary.academic.users.index','secretary.academic.users.create','secretary.academic.users.store','secretary.academic.users.show','secretary.academic.users.edit',
'secretary.academic.users.update','secretary.academic.users.destroy','secretary.academic.subscriptions.index','secretary.academic.subscriptions.create','secretary.academic.subscriptions.store',
'secretary.academic.subscriptions.show','secretary.academic.subscriptions.edit','secretary.academic.subscriptions.update','secretary.academic.subscriptions.destroy','secretary.attendance.index',
'secretary.attendance.show','teacher.dashboard','teacher.attendance.index','teacher.attendance.show','parent.dashboard',
'parent.children.index','parent.payments.index','parent.payments.upload','parent.payments.store','storage.local',
'storage.local.upload',);
        registerArgumentsSet('views', 
'admin.academic.groups.index','admin.academic.groups.show','admin.academic.students.index','admin.academic.students.show','admin.academic.users.index',
'admin.attendance.index','admin.attendance.show','admin.dashboard','admin.payments.cash','admin.payments.history',
'admin.payments.pending','auth.login','components.attendance-row','components.card','components.code-block',
'components.code-reveal-modal','components.confirmation-dialog','components.empty-state','components.group-card','components.nav-bottom-bar',
'components.nav-side-drawer','components.page-header','components.search-bar','components.stat-card','components.status-badge',
'errors.403','errors.500','layouts.app','layouts.auth','parent.dashboard',
'parent.payments.confirmation','parent.payments.index','parent.payments.upload','secretary.dashboard','teacher.attendance.index',
'teacher.attendance.show','teacher.dashboard','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
